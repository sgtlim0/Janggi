...
/** Advisor moves: identical to King (1 step orthogonal + palace diagonal, must stay in palace) */
export function getAdvisorMoves(board: BoardState, pos: Position, player: Player): Position[] {
